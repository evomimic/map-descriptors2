...
test('create and update PropertyDescriptor', async () => {
  await runScenario(async scenario => {
    ...
    let updateInput = {
      original_property_descriptor_hash: originalActionHash,
      previous_property_descriptor_hash: originalActionHash,
      updated_property_descriptor: contentUpdate,
    };
    ...
    updateInput = { 
      original_property_descriptor_hash: originalActionHash,
      previous_property_descriptor_hash: updatedRecord.signed_action.hashed.hash,
      updated_property_descriptor: contentUpdate,
    };
